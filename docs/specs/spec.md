...
| warning | noun | The condition where a control server accepts a policy document and reports a fact about it, which a Tailscale control server states as the message `warning(s) found`. | caution, notice, alert |
