...
| 2026-08-05 | 1 | Issue #211. **`docs/README.md` names no `UPGRADING.md`, because issue #163 has not yet written that file.** The acceptance criteria of issue #211 require that every relative link resolves, and a link to an absent file breaks that criterion. The index names `DESIGN.md`, `dns-investigation.md`, `security-audit.md`, `specs/`, and `images/`. Issue #163 adds the row for `UPGRADING.md`. |
